...
void special_key_pressed(int key, int x, int y) {
    ...
    // we can find the perpendicular vector by cross product of up vector and look vector
...
float* normalize(float vector[3]) {
    ...
    // magnitude 
    float magnitude = vector[0] * vector[0] + vector[1] * vector[1] + vector[2] * vector[2];
